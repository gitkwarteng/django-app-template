...
djsettings.celery_broker_url = os.getenv('CELERY_BROKER_URL', 'redis://127.0.0.1:6379/1')
djsettings.celery_result_backend = os.getenv('CELERY_RESULT_BACKEND', 'redis://127.0.0.1:6379/2')
djsettings.celery_accept_content = ['json']
djsettings.celery_task_serializer = 'json'
djsettings.celery_result_serializer = 'json'
